...
public class dxmCrafting
{
       ...
       {
             GameRegistry.addShapelessRecipe(new ItemStack(dxm.squeeBlock), new Object[]{
                    new ItemStack(Item.diamond), new ItemStack(Block.stone), new ItemStack(Item.dyePowder, 1, 15)
             });
            
             GameRegistry.addRecipe(new ItemStack(dxm.squeeBlock), new Object[]{
            	 "XZX",
                 "XZX",
                 "CXC",
             ...
             GameRegistry.addShapelessRecipe(enchanted, new Object[]{
                           new ItemStack(Item.pickaxeStone), new ItemStack(Item.flint), new ItemStack(dxm.squeeBlock)
             });
