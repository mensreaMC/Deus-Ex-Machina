...
public class ItemHemp extends Item
{
  ...
  {
    world.spawnParticle("smoke", player.posX, player.posY, 
      player.posZ, 0.0D, 0.0D, 0.0D);
    world.spawnParticle("smoke", player.posX - 0.3D, player.posY, 
      player.posZ, 0.0D, 0.0D, 0.0D);
    world.spawnParticle("smoke", player.posX, player.posY - 0.3D, 
      player.posZ, 0.0D, 0.0D, 0.0D);
    world.spawnParticle("smoke", player.posX, player.posY, 
      player.posZ - 0.3D, 0.0D, 0.0D, 0.0D);
